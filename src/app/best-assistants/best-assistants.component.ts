...
@Component({
  selector: 'app-best-assistants',
  templateUrl: './best-assistants.component.html',
  styleUrls: ['./best-assistants.component.css']
})
export class BestAssistantsComponent implements OnInit {
  ...
  getPlayers() {
    this.playerService.getPlayers().subscribe(player => {
      ...
      this.allPlayers.sort((a, b) => (a.assists < b.assists) ? 1 : -1)
